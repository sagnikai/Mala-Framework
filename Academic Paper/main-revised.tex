...
\begin{itemize}
  ...
  \item \textbf{Supply chain logistics}: Global shipping ports and rail networks often depend on archaic, file-based communication protocols like flat CSVs or AS2. RCE seamlessly integrates these static files with live terminal data, allowing real-time rerouting of cargo under constrained resource limits.
\end{itemize}
